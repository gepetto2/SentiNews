      ...
      {isInfoOpen && (
        ...
        >
          ...
          <p style={{ margin: 0, marginBottom: "6px" }}>
            Aplikacja analizująca nastrój lokalnych wiadomości i postów
            w wybranym województwie.
          </p>
          <p style={{ margin: 0, marginBottom: "6px" }}>
            Pobiera nagłówki (oraz ewentualnie skróty) newsów lub wpisy
            z Twittera/Reddita/Facebooka po polsku.
          </p>
          <p style={{ margin: 0, marginBottom: "6px" }}>
          ...
          <p style={{ margin: 0 }}>
            Umożliwia analizę &quot;temperatury emocjonalnej&quot; regionu
            lub całego kraju.
          </p>
        </div>
      )}
